...
print(f"Maquina A: {media_A} Mediana: {mediana_A} Variancia: {variancia_A:.2f} desvio_padrao_A: {desvio_padrao_A:.2f} coef. var.: {cv_A}")
...
cv_B = (desvio_padrao_B / media_B) * 100
print(f"Maquina B: {media_B} Mediana: {mediana_B} Variancia: {variancia_B:.2f} desvio_padrao_B: {desvio_padrao_B:.2f} coef. var.: {cv_B}")
