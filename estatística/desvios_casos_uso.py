...
# 1. Importar dados
df = pd.read_csv('estatística/funcionarios.csv')
...
# 3.3 DAM(Desvio Absoluto Médio) Engajamento
...
# 3.4 Variância Meses p/ promoção
...
# 3.5 Amplitude do Custo de Saúde
