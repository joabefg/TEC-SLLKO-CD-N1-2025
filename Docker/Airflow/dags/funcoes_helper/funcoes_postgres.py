...
# 4. Salvar dados do banco de dados
def inserir_dados(ti):
    ...
    for livro in dados_livros:
        postgres_hook.run(sql, parameters=(livro['ISBN'], livro['Book-Title'],livro['Book-Author'], livro['ano'],
        livro['Publisher'], livro['Image-URL-S'], livro['Preco']))