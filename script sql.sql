...
select cliente_id, cliente_codigo, cliente_razao from cliente;
-- where = igual
select cliente_razao from cliente where cliente_codigo = '0001';
-- where diferenciado
select cliente_razao from cliente where cliente_codigo <> '0001';
-- where maior
select cliente_razao from cliente where cliente_codigo > 5;
-- DISTINCT
select distinct cliente_id from venda;
-- IN
select cliente_id, cliente_razao from cliente where cliente_id IN (1, 2, 3);
-- NOT IN
select cliente_id, cliente_razao from cliente where cliente_id NOT IN (1, 2, 3);
-- subconsuta; razao social de quem realizou a compra
...
select SUM(venda_total) from venda
 where venda_data between '2015-01-01' and '2015-01-01';
-- media
