...
axbx.set_title('Frequência Cardiaca (BPM)')
axbr.bar(['Atleta', 'Sedentario'], [res_atleta['CV'], res_sedent['CV']])
axbr.set_title("Coeficiente da Variação (%) - Saúde")
