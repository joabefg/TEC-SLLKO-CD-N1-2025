...
k = round(k_sturges)
print(f"4. Números de classes (k): {k} \n")
...
frequencia_abs = pd.cut(rol, bins=bins, include_lowest=True, right=False).value_counts().sort_index()
print(f"Frequências absolutas: \n {frequencia_abs} \n")
...
plt.ylabel('Frequência Absotuta')
