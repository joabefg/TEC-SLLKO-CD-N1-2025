...
dominos = [26, 30, 31, 29, 30, 32, 29, 30, 31, 30]
...
# Exibir dados
print(f"{'Metrica':<20} | {'Dominos':<20} | {'Italiana':<20}")
print(f"{'Media':<20} | {dm_media:<20} | {it_media:<20}")
print(f"{'Amplitude':<20} | {dm_amplitude:<20} | {it_amplitude:<20}")
print(f"{'DAM':<20} | {dm_dam:<20} | {it_dam:<20}")
print(f"{'Variancia':<20} | {dm_variancia:<20} | {it_variancia:<20}")
print(f"{'Desvio_padrao':<20} | {dm_desvio_padrao:<20} | {it_variancia:<20}")
print(f"{'CV':<20} | {dm_cv:<20} | {it_cv:<20}")