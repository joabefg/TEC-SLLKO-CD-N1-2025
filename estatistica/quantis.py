...
print("Quartis das pressões medidas: ")
print(df_quartis)
print("\n")

# 3. Limites
iqr = q3 - q1
limite_inferir = q1 - (1.5 * iqr)
limite_superior = q3 + (1.5 * iqr)
df_limites = pd.DataFrame({
    'Limites': ['Inferior', 'Superior'], 
    'Valor': [limite_inferir, limite_superior]
})
...
# 4. Outliers
outliers = [x for x in dados if x < limite_inferir or x >limite_superior]
